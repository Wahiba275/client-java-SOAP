 ...
 * 
 */
@WebServiceClient(name = "BanqueWS", targetNamespace = "http://enset.ma/", wsdlLocation = "http://localhost:9191/BanqueService?wsdl")
    ...
    extends Service
{
    ...
    private static final QName BANQUEWS_QNAME = new QName("http://enset.ma/", "BanqueWS");
    ...
    public BanqueService getBanqueServicePort() {
        return super.getPort(new QName("http://enset.ma/", "BanqueServicePort"), BanqueService.class);
    }
    ...
    public BanqueService getBanqueServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://enset.ma/", "BanqueServicePort"), BanqueService.class, features);
    }
