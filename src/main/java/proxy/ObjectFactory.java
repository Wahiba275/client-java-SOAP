...
public class ObjectFactory {
    ...
    private static final QName _Convert_QNAME = new QName("http://enset.ma/", "Convert");
    private static final QName _ConvertResponse_QNAME = new QName("http://enset.ma/", "ConvertResponse");
    private static final QName _Compte_QNAME = new QName("http://enset.ma/", "compte");
     ...
     */
    @XmlElementDecl(namespace = "http://enset.ma/", name = "Convert")
     ...
     */
    @XmlElementDecl(namespace = "http://enset.ma/", name = "ConvertResponse")
